...
def throneRoom1END():
    ...
    print("[It seems as though there is no other option - a fight to the death it will be.]")
    ...
    while roomLoop:
      ...
      for word in splinterPlainsInput.split():   
        if word in west:
          ...
          print("You search the armoured warrior and find nothing of great interest.")
...
def shacktronic5END():
    ...
    print("You defeat the the Shack O'Tronic and are hailed as the new champions of this land.")
